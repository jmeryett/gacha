  ...
  methods: {
    ...
    battle: function () {
      ...
      if (!this.battleMode && !this.gameover) {
        ...
        this.playerRoll = this.roll(this.currentUnit.max);
        this.enemyRoll = this.roll(this.currentEnemy.max);
    ...
    reroll: function () {
      ...
      switch (random) {
        ...
        case 6:
        case 7:
          this.currentUnit.name = 'Three Gnomes in a Coat';
    ...
    reset: function () {
      this.enemySet = [
        ...
        {
          name: 'Elf Firing Two Bows Somehow',
          max: 8
        },
        {
